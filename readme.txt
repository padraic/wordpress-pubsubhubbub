...
Any Pubsubhubbub enabled Subscriber can then receive an almost immediate update from any of your Hubs containing the actual update for immediate use. Subscribers know what Hubs to use when subscribing to your RSS 2.0 or Atom feed since this plugin will insert one or more links to your configured Hubs into these feeds.
...
* Where no Hub is configured, WP Pubsubhubbub defaults to the reference Hub hosted on Google App Engine. This is a very reliable Hub.
...
3. Enter one or more custom hubs under your WP Pubsubhubbub Settings (optional - default hub preset)
...
You can learn more about [Padraic Brady](http://blog.astrumfutura.com "Padraic Brady") at [his blog](http://blog.astrumfutura.com "his blog")

== Screenshots ==

1. Use the WP Pubsubhubbub settings page to configure one or more Hubs for use
